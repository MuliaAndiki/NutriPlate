...
import GrafikPertumbuhanAnakKaderHeroSection from "@/components/section/private/kader/daftar-balita/detail-anak/grafik-pertumbuhan-anak/grafik-pertumbuhan-anak-section";
...
const GrafikPertumbuhanAnakKaderContainer = () => {
  ...
  return (
    <SidebarLayout>
      <main className="w-full min-h-screen overflow-x-hidden">
        <GrafikPertumbuhanAnakKaderHeroSection
          namespace={{
...
export default GrafikPertumbuhanAnakKaderContainer;

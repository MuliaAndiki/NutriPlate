...
const EditProfileAdminContainer = () => {
    ...
    try {
      ...
      if (res.data.isUpdateEmail) {
        nameSpace.router.push(
          `/verify?identifier=${email}&target=/admin/profile`,
        );
      } else {
        nameSpace.router.push("/admin/profile");
      }
...
export default EditProfileAdminContainer;

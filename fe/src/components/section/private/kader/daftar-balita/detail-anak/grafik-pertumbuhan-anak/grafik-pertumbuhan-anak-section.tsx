...
interface GrafikPertumbuhanAnakKaderSection {
  namespace: {
...
const GrafikPertumbuhanAnakKaderHeroSection: React.FC<
  GrafikPertumbuhanAnakKaderSection
...
export default GrafikPertumbuhanAnakKaderHeroSection;

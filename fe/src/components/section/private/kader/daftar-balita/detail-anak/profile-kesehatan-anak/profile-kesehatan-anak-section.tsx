...
interface ProfileKesehatanAnakKaderSectionProps {
  namespace: {
...
const ProfileKesehatanAnakKaderSection: React.FC<
  ProfileKesehatanAnakKaderSectionProps
> = ({ namespace, service }) => {
...
export default ProfileKesehatanAnakKaderSection;

...
import EditProfileKaderSectionSkeleton from "@/components/skeleton/private/kader/profile/edit-profile/edit-profile-section-skeleton";
import DataNotFound from "@/components/empty/data-not-found";
import { Spinner } from "@/components/ui/spinner";

interface EditProfileKaderSectionProps {
  namespace: {
  ...
  service: {
    mutation: {
      ...
      onChangeAvatars: (e: React.ChangeEvent<HTMLInputElement>) => void;
      isPending: boolean;
    };
    query: {
      profileUser: IAuth;
...
const EditProfileKaderSection: React.FC<EditProfileKaderSectionProps> = ({
  namespace,
  service,
  state,
}) => {
  ...
  if (service.query.isLoading) {
    return <EditProfileKaderSectionSkeleton />;
  }
...
export default EditProfileKaderSection;

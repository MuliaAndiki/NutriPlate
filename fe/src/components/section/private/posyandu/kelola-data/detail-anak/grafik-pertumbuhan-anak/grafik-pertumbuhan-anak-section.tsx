...
interface GrafikPertumbuhanAnakPosyanduSection {
  namespace: {
...
const GrafikPertumbuhanAnakPosyanduHeroSection: React.FC<
  GrafikPertumbuhanAnakPosyanduSection
...
export default GrafikPertumbuhanAnakPosyanduHeroSection;
